...
export const eventServices: Service[] = [
    ...
    },
    {
        ...
        longDescription: "Every birthday is a milestone worth celebrating in style. Whether you want an intimate gathering for close family, a lavish 50th birthday bash, a 1st birthday extravaganza, or a surprise party — DevKarma Events brings your vision to life. We handle theme conceptualisation, venue styling, entertainment, catering, custom cakes, and every little personal touch that makes the celebration uniquely yours.",
        image: "/portfolio/gallery/pre-wedding-1.jpg",
...
export const portfolioGallery: GalleryImage[] = [
    { id: 1, src: "/portfolio/gallery/wedding-couple-5.jpg", category: "Wedding", title: "Grand Wedding Celebration" },
    { id: 2, src: "/portfolio/gallery/wedding-couple-6.jpg", category: "Wedding", title: "Elegant Wedding Setup" },
    { id: 3, src: "/portfolio/gallery/wedding-couple-7.jpg", category: "Wedding", title: "Traditional Wedding Ceremony" },
    { id: 4, src: "/portfolio/gallery/wedding-jyoti.jpg", category: "Wedding", title: "Joyful Wedding Moments" },
    { id: 5, src: "/portfolio/gallery/wedding-bride-1.jpg", category: "Wedding", title: "Bridal Celebration" },
    { id: 6, src: "/portfolio/gallery/wedding-bride-2.jpg", category: "Wedding", title: "Wedding Décor Showcase" },
    { id: 7, src: "/portfolio/gallery/commercial-1.jpg", category: "Corporate", title: "Corporate Conference" },
    { id: 8, src: "/portfolio/gallery/commercial-2.webp", category: "Corporate", title: "Product Launch Event" },
    { id: 9, src: "/portfolio/gallery/commercial-3.webp", category: "Corporate", title: "Award Night Gala" },
    { id: 10, src: "/portfolio/gallery/commercial-4.webp", category: "Exhibition", title: "Brand Activation" },
    { id: 11, src: "/portfolio/gallery/commercial-5.webp", category: "Exhibition", title: "Exhibition Stall" },
    { id: 12, src: "/portfolio/gallery/commercial-6.webp", category: "Corporate", title: "Corporate Networking Event" },
    { id: 13, src: "/portfolio/gallery/pre-wedding-1.jpg", category: "Destination", title: "Destination Wedding Setup" },
    { id: 14, src: "/portfolio/gallery/pre-wedding-2.jpg", category: "Destination", title: "Outdoor Celebration" },
    { id: 15, src: "/portfolio/gallery/pre-wedding-3.jpg", category: "Destination", title: "Scenic Venue Event" },
    { id: 16, src: "/portfolio/gallery/pre-wedding-4.jpg", category: "Birthday", title: "Birthday Celebration Décor" },
    { id: 17, src: "/portfolio/gallery/pre-wedding-5.jpg", category: "Birthday", title: "Private Party Setup" },
    { id: 18, src: "/portfolio/gallery/commercial-8.webp", category: "Cultural", title: "Cultural Evening Show" },
    { id: 19, src: "/portfolio/gallery/commercial-9.webp", category: "Cultural", title: "Festival Management" },
    { id: 20, src: "/portfolio/gallery/commercial-10.webp", category: "Exhibition", title: "Expo Management" },
    { id: 21, src: "/portfolio/gallery/wedding-couple-3.jpg", category: "Wedding", title: "Mandap Decoration" },
    { id: 22, src: "/portfolio/gallery/wedding-couple-4.jpg", category: "Wedding", title: "Wedding Reception" },
    { id: 23, src: "/portfolio/gallery/pre-wedding-6.jpg", category: "Destination", title: "Destination Retreat" },
    { id: 24, src: "/portfolio/gallery/pre-wedding-7.jpg", category: "Birthday", title: "Milestone Birthday Party" },
    { id: 25, src: "/portfolio/gallery/commercial-12.webp", category: "Cultural", title: "Award Night Décor" },
];
